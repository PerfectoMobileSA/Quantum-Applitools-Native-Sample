...
public class CalcPage extends WebDriverBaseTestPage<WebDriverTestPage> {
	...
	public void add(long l1, long l2){
		new QAFExtendedWebElement(String.format(ConfigurationManager.getBundle().getString("btn.number"), l1)).click();
		new QAFExtendedWebElement("btn.plus").click();
		new QAFExtendedWebElement(String.format(ConfigurationManager.getBundle().getString("btn.number"), l2)).click();
